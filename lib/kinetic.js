...
/**
 * GETVERSION request following the kinetic protocol.
 * @param {number} sequence - monotonically increasing number for each
 *                                request in a TCP connection
 * @param {number} clusterVersion - The version number of this cluster
 *                                  definition
...
/**
 * Response for the GETVERSION request following the kinetic protocol.
 * @param {number} ackSequence - monotically increasing number for each request
 *                               in a TCP connection
 * @param {number} dbVersion - the version of the object in the DB
 * @param {number} response - response code (SUCCESS, FAIL)
 * @param {Buffer} errorMessage - Detailed error message.
 * @returns {Kinetic} - message structure following the kinetic protocol
 */
...
/**
 * GET NEXT request following the kinetic protocol.
 * @param {number} sequence - monotonically increasing number for each
 *                                request in a TCP connection
 * @param {number} clusterVersion - The version number of this cluster
 *                                  definition
 * @param {Buffer} key - key of the item before to the one to get.
 * @returns {Kinetic} - message structure following the kinetic protocol
 */
...
/**
 * Response for the GETNEXT request following the kinetic protocol.
 * @param {number} ackSequence - monotically increasing number for each request
 *                               in a TCP connection
 * @param {Buffer} key - key for the value that is being returned.
 * @param {number} dbVersion - the version of the object in the DB
 * @param {number} response - response code (SUCCESS, FAIL)
 * @param {Buffer} errorMessage - Detailed error message.
 * @returns {Kinetic} - message structure following the kinetic protocol
...
/**
 * GETPREVIOUS request following the kinetic protocol.
 * @param {number} sequence - monotonically increasing number for each
 *                                request in a TCP connection
 * @param {number} clusterVersion - The version number of this cluster
 *                                  definition
 * @param {Buffer} key - key of the item next to the one to get.
 * @returns {Kinetic} - message structure following the kinetic protocol
 */
...
/**
 * Response for the GETPREVIOUS request following the kinetic protocol.
 * @param {number} ackSequence - monotically increasing number for each request
 *                               in a TCP connection
 * @param {Buffer} key - key for the value that is being returned.
 * @param {number} dbVersion - the version of the object in the DB
...
/**
 * GETKEYRANGE request following the kinetic protocol.
 * @param {number} sequence - monotonically increasing number for each
 *                                request in a TCP connection
 * @param {number} clusterVersion - The version number of this cluster
 *                                  definition
 * @param {Buffer} startKey - the beginning of the requested range.
 * @param {Buffer} endKey - the end of the requested range.
 ...
 *                                                      end key should be
 *                                                      included
 *        {boolean} [options.reverse = false] - If true, the key range will be
...
/**
 * Response for the GETKEYRANGE request following the kinetic protocol.
 * @param {number} ackSequence - monotically increasing number for each request
 *                               in a TCP connection
...
/**
 * START_BATCH request following the kinetic protocol.
 * @param {number} sequence - monotonically increasing number for each
 *                                request in a TCP connection
 * @param {number} clusterVersion - The version number of this cluster
 *                                  definition
...
/**
 * Response for the START_BATCH request following the kinetic protocol.
 * @param {number} ackSequence - monotically increasing number for each request
 *                               in a TCP connection
 * @param {number} connectionID - the connection ID received from the InitPDU
 * @param {number} response - response code (SUCCESS, FAIL)
...
/**
 * END_BATCH request following the kinetic protocol.
 * @param {number} sequence - monotonically increasing number for each
 *                                request in a TCP connection
 * @param {number} clusterVersion - The version number of this cluster
 *                                  definition
...
/**
 * Response for the END_BATCH request following the kinetic protocol.
 * @param {number} ackSequence - monotically increasing number for each request
 *                               in a TCP connection
 * @param {number} connectionID - the connection ID received from the InitPDU
 * @param {number} response - response code (SUCCESS, FAIL)

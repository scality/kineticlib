...
export class GetLogResponsePDU extends PDU {
    constructor(response, errorMessage, responseLogs, incrementTCP) {
        super();
        if (!Buffer.isBuffer(errorMessage))
            throw new Error("the error message is not a buffer");
        this.setMessage({
            "header": {
                "ackSequence": incrementTCP,
...
export class FlushResponsePDU extends PDU {
    constructor(response, errorMessage, incrementTCP) {
        super();
        if (!Buffer.isBuffer(errorMessage))
            throw new Error("the error message is not a buffer");
        this.setMessage({
...
export class GetResponsePDU extends PDU {
    constructor(key, response, errorMessage, dbVersion, incrementTCP) {
        super();
        if (!Buffer.isBuffer(errorMessage))
            throw new Error("the error message is not a buffer");
        if (!Buffer.isBuffer(dbVersion))
